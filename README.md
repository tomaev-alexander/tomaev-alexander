...
<p> В рамках своего опыта работы с нейронными сетями я создавал векторные представления изображений, решал задачи их классификации, а также детекции объектов на них. Кроме того, мне знакомы задачи векторного представления и классификации текстов. Мной применялись в том числе архитектура Трансформер, Hugging Face модели. </p>
