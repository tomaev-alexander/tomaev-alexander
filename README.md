...
<p> Также у меня есть опыт работы с нейронными сетями. Я создавал векторные представления изображений, решал задачи классификации изображений, детекции объектов на них. Мне также знакомы задачи векторного представления и классификации текстов. Применял архитектуру Трансформер, Hugging Face модели. </p>
