...
<p> Также у меня есть опыт работы с нейронными сетями. Я создавал векторные представления изображений, решал задачи их классификации, а также детекции объектов на них. Кроме того, мне знакомы задачи векторного представления и классификации текстов. Мной применялась и архитектура Трансформер, Hugging Face модели. </p>
