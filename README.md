...
<p> Также у меня есть опыт работы с нейронными сетями. Я создавал векторные представления изображений, решал задачи их классификации, а также детекции объектов на них. Мне также знакомы задачи векторного представления и классификации текстов. Мной применялась архитектура Трансформер, Hugging Face модели. </p>
