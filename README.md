...
<p> Также я имею опыт работы со сверточными нейронными сетями. Делал векторные представления изображений, решал задачи классификации изображений, детекции объектов на них. Помимо этого я создавал векторные представления текстов, решал задачи классификации текстов. Применял архитектуру Трансформер, Hugging Face модели. </p>
