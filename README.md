...
<h3> </br> Меня зовут Александр, я <b>Data Scientist</b> / <b>ML инженер</b> <img src="https://cdn-icons-png.flaticon.com/128/5968/5968350.png" width="13"/>, открытый для сотрудничества.   </h3>
...
<p> Также у меня есть опыт работы с нейронными сетями. Я создавал векторные представления изображений, решал задачи их классификации, а также детекции объектов на них. Кроме того, мне знакомы задачи векторного представления и классификации текстов. Среди прочих мной применялась архитектура Трансформер, Hugging Face модели. </p>
